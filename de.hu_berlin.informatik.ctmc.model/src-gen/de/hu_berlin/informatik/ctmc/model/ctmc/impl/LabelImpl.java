 ...
 * </p>
 * <ul>
 *   <li>{@link de.hu_berlin.informatik.ctmc.model.ctmc.impl.LabelImpl#getText <em>Text</em>}</li>
 *   <li>{@link de.hu_berlin.informatik.ctmc.model.ctmc.impl.LabelImpl#getState <em>State</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LabelImpl extends MinimalEObjectImpl.Container implements Label {
	...
	public void setText(String newText) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CtmcPackage.LABEL__TEXT, oldText, text));
	}
	...
	public State getState() {
		if (eContainerFeatureID() != CtmcPackage.LABEL__STATE)
			return null;
	...
	public void setState(State newState) {
		if (newState != eInternalContainer()
				|| (eContainerFeatureID() != CtmcPackage.LABEL__STATE && newState != null)) {
