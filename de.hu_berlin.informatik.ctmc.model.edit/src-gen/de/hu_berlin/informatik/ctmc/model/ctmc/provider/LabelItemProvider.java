...
/**
 * This is the item provider adapter for a {@link de.hu_berlin.informatik.ctmc.model.ctmc.Label} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LabelItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addTextPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Label_text_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Label_text_feature", "_UI_Label_type"),
						CtmcPackage.Literals.LABEL__TEXT, true, false, false,
	...
	protected void addStatePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Label_state_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Label_state_feature", "_UI_Label_type"),
						CtmcPackage.Literals.LABEL__STATE, true, false, true, null, null, null));
	}
