...
/**
 * This is the item provider adapter for a {@link de.hu_berlin.informatik.dynamicFaultTree.Event} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EventItemProvider extends ElementItemProvider {
	/**
	...
	protected void addParentGatePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Event_parentGate_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Event_parentGate_feature",
								"_UI_Event_type"),
						DynamicFaultTreePackage.Literals.EVENT__PARENT_GATE, true, false, true, null, null, null));
	}
	...
	protected void addDependencyPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Event_dependency_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Event_dependency_feature",
								"_UI_Event_type"),
						DynamicFaultTreePackage.Literals.EVENT__DEPENDENCY, true, false, true, null, null, null));
	}
