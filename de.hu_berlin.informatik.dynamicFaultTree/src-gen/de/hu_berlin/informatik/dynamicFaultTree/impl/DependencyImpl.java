 ...
 * </p>
 * <ul>
 *   <li>{@link de.hu_berlin.informatik.dynamicFaultTree.impl.DependencyImpl#getEvents <em>Events</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class DependencyImpl extends ElementImpl implements Dependency {
	/**
	...
	protected EClass eStaticClass() {
		return DynamicFaultTreePackage.Literals.DEPENDENCY;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case DynamicFaultTreePackage.DEPENDENCY__EVENTS:
