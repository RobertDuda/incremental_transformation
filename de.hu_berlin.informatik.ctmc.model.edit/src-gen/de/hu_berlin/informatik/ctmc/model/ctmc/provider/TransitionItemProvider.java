...
/**
 * This is the item provider adapter for a {@link de.hu_berlin.informatik.ctmc.model.ctmc.Transition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TransitionItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Transition_name_feature",
								"_UI_Transition_type"),
						CtmcPackage.Literals.TRANSITION__NAME, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Transition_probability_feature",
								"_UI_Transition_type"),
						CtmcPackage.Literals.TRANSITION__PROBABILITY, true, false, false,
	...
	protected void addDurationPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Transition_duration_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Transition_duration_feature",
								"_UI_Transition_type"),
						CtmcPackage.Literals.TRANSITION__DURATION, true, false, false,
						ItemPropertyDescriptor.REAL_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Transition_from_feature",
								"_UI_Transition_type"),
						CtmcPackage.Literals.TRANSITION__FROM, true, false, true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Transition_to_feature",
								"_UI_Transition_type"),
						CtmcPackage.Literals.TRANSITION__TO, true, false, true, null, null, null));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		case CtmcPackage.TRANSITION__NAME:
		case CtmcPackage.TRANSITION__PROBABILITY:
		case CtmcPackage.TRANSITION__DURATION:
